...
<railo-configuration password="ad9671800f150811a9b67dd86911f984e28518dd57759790" version="2.0">
...
<!--	or ask your database distributor 																-->
	...
	<data-sources>
	<data-source allow="415" blob="false" class="org.h2.Driver" clob="false" connectionLimit="-1" connectionTimeout="1" custom="" database="railo-heroku-cfdistro" dsn="jdbc:h2:./h2dbs/railo-heroku-cfdistro" host="127.0.0.1" name="railo-heroku-cfdistro" password="" port="3306" username="sa"/>
</data-sources>
    ...
    <remote-clients directory="{railo-web}remote-client/" log="/workspace/railo-heroku-cfdistro/build/temp/log" log-level="info"/>
	...
	-->
	<scope client-directory="{railo-web}/client-scope/" client-directory-max-size="100mb" requesttimeout-log="/workspace/railo-heroku-cfdistro/build/temp/log/requesttimeout.log"/>
		
	<mail log="/workspace/railo-heroku-cfdistro/build/temp/log/mail.log">
	</mail>
	...
	<!--
	 ...
	 -->
	<debugging debug="false" memory-log="/workspace/railo-heroku-cfdistro/build/temp/log/memory.log" template="/railo-context/templates/debugging/debugging.cfm"/>
