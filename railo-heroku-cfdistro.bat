...
cls
echo.
echo       railo-heroku-cfdistro menu
REM echo       usage: railo-heroku-cfdistro.bat [start|stop|{target}]
echo.
...
echo to stop the server, run this again or run: railo-heroku-cfdistro.bat stop
goto end
::
:stopServer
